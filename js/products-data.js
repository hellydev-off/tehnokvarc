// Данные карточек товара для страницы product.html.
// Ключ — id из ссылки product.html?id=..., которым помечены карточки
// на главной, в каталоге (gravel.html) и в блоке «Лидеры продаж».
const PRODUCTS = {
  '0.10-0.63': {
    title: 'Кварцевый песок фракции 0,10-0,63 мм',
    fraction: '0,10 - 0,63 мм',
    priceMF: '9 000 ₽',
    priceMKR: '3 600 ₽',
